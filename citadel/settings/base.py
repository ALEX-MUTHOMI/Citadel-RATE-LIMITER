...
ASGI_APPLICATION = "citadel.asgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "citadel"),
...
CITADEL_API_TOKEN = os.getenv("CITADEL_API_TOKEN", "")
CITADEL_BOOTSTRAP_CLIENT = os.getenv("CITADEL_BOOTSTRAP_CLIENT", "local-docker")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Citadel Rate Limiter",
    "DESCRIPTION": "Shared rate limiter API for Citadel projects.",
    "VERSION": "0.1.0",
}
